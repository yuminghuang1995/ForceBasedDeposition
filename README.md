...
This project contains data for all models in paper, including obj files in **models** folder, toolpath information (3D coordinates and normal vectors), extrusion information (Geometry-based and Force-based) and number of layers in **toolpaths** folder.
